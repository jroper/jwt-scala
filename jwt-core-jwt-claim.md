...
claim.expiresNow
// res12: JwtClaim = pdi.jwt.JwtClaim@8ecd304b

// Set the beginning of the token (aka the "not before" attribute)
// 5 seconds ago
claim.startsIn(-5)
// res13: JwtClaim = pdi.jwt.JwtClaim@abadac04
// At a specific timestamp (in seconds)
claim.startsAt(1431520421)
// res14: JwtClaim = pdi.jwt.JwtClaim@dc8d0434
// Right now!
...
// 5 seconds ago
claim.issuedIn(-5)
// res16: JwtClaim = pdi.jwt.JwtClaim@d0c38513
// At a specific timestamp (in seconds)
claim.issuedAt(1431520421)
// res17: JwtClaim = pdi.jwt.JwtClaim@778066e3
// Right now!
...
claim.toJson
// res21: String = "{\"iss\":\"Me\",\"sub\":\"Something\",\"aud\":\"You\",\"exp\":1616419966,\"nbf\":1616419961,\"iat\":1616419961,\"jti\":\"42\",\"user\":1,\"key1\":\"value1\",\"key2\":true,\"key3\":3,\"key4\":[1,2],\"key5\":{\"key5.1\":\"Subkey\"}}"
```
