...
claim.expiresNow
// res12: JwtClaim = pdi.jwt.JwtClaim@d6e6f0b6

// Set the beginning of the token (aka the "not before" attribute)
// 5 seconds ago
claim.startsIn(-5)
// res13: JwtClaim = pdi.jwt.JwtClaim@12a8ca79
// At a specific timestamp (in seconds)
claim.startsAt(1431520421)
// res14: JwtClaim = pdi.jwt.JwtClaim@36316d2b
// Right now!
...
// 5 seconds ago
claim.issuedIn(-5)
// res16: JwtClaim = pdi.jwt.JwtClaim@b98c9701
// At a specific timestamp (in seconds)
claim.issuedAt(1431520421)
// res17: JwtClaim = pdi.jwt.JwtClaim@a1ebd60f
// Right now!
...
claim.toJson
// res21: String = "{\"iss\":\"Me\",\"sub\":\"Something\",\"aud\":\"You\",\"exp\":1617613117,\"nbf\":1617613112,\"iat\":1617613112,\"jti\":\"42\",\"user\":1,\"key1\":\"value1\",\"key2\":true,\"key3\":3,\"key4\":[1,2],\"key5\":{\"key5.1\":\"Subkey\"}}"
```
